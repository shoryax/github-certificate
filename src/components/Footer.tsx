      ...
      <form className="w-full max-w-xl mx-auto space-y-4 px-4">
        <div className="flex gap-4">
          <div className="flex-1">
            <label className="block text-xs text-[#F2F2F2] mb-1">Name <span className="text-[#4E5896]">*</span></label>
            <input
              type="text"
          ...
          <div className="flex-1">
            <label className="block text-xs text-[#F2F2F2] mb-1">Email <span className="text-[#4E5896]">*</span></label>
            <input
              type="email"
              className="w-full bg-[#111015] text-white text-sm px-3 py-2 rounded-md border border-[#1C1C1C]"
            />
        ...
        <div>
          <label className="block text-xs text-[#F2F2F2] mb-1">Message <span className="text-[#4E5896]">*</span></label>
          <textarea
            className="w-full bg-[#111015] text-white text-sm px-3 py-2 rounded-md border border-[#1C1C1C]"
          ></textarea>
        </div>
