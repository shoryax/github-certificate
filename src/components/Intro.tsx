export default function Intro() {
  return (
    <div id="home" className="px-4 sm:px-8 lg:px-20 mx-auto">
      <div className="sm:max-w-3xl rounded px-32">
        ...
        <div className="text-gray-400 w-full text-sm sm:text-base">
          I'm currently a{' '}
      ...
      <div className="flex flex-col sm:flex-row sm:space-x-10 my-8 mb-2 px-32 text-gray-400 text-sm sm:text-base">
        <div>Projects</div>
      ...
      <hr className="mx-auto w-[81%] my-4" style={{ color: '#684574' }} />
    </div>
  );
}
